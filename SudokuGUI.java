...
public class SudokuGUI extends JFrame implements ActionListener  {
    ...
    public void actionPerformed(ActionEvent e) {
         ...
         */
        	...
        	if(obj.isValid(puzzle)==false){
        		...
        		Object[] options = { "OK"};
            	JOptionPane.showOptionDialog(null, "The puzzle you entered is unsolvable please enter " +
        	...
        	if(justSolved == true){
        		Object[] options = { "OK"};
            	JOptionPane.showOptionDialog(null, "Already solved please clear the " +
            										"puzzle\n or load a new one in :)", "Warning",
        		...
        		Object[] options = { "OK"};
            	JOptionPane.showOptionDialog(null, "You didnt enter a puzzle", "Warning",
    	 ...
    	 */
        	...
        	Object[] options = { "OK"};
        	JOptionPane.showOptionDialog(null, "Input should look like: no space needed\n102356000" +
        										"\n987600\nYou can also leave blank: \n12341\n059\nHowever, if you want" +
        										"To put spaces you can\nEx: 123 654 9 8 7", "Rules",
    ...
    public static void main(String args[]){
        ...
        JOptionPane.showOptionDialog(null, "Welcome to the Sudoku solver", 
    	        ...
    	        null, options, options[0]);
        gui.addWindowListener(new WindowAdapter() {      // Quit the application
    ...
    /*
     * I created this as a fail safe to prevent accendital
     * errors when reading in a puzzle this method is used
     * to reset the puzzle variable and justUsed variable
     * to enable the read button again.
     */
